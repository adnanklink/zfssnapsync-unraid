...
fixture="$(mktemp -d "${ZFSAS_POOL_FIXTURE_ROOT:?}/coordinator-refresh.XXXXXXXX")"
...
php tests/reliability/coordinator_refresh_zfs.php "$source_pool" "$target_pool" "$fixture"
