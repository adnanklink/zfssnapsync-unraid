...
fixture="$(mktemp -d "${ZFSAS_POOL_FIXTURE_ROOT:?}/replication-recovery.XXXXXXXX")"
...
php tests/reliability/replication_recovery_zfs.php "$source_pool" "$target_pool" "$fixture"
